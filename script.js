...
function playIntroSequence() {
    ...
    // After 2 seconds, fade out and switch to second image
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            // After another 2 seconds, fade out and show start overlay
            setTimeout(() => {
                introImage.classList.remove('fade-in');
                setTimeout(() => {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // AI difficulty select - Fixed to work properly
    aiDifficultySelect.addEventListener('change', function(event) {
        event.stopPropagation(); // Prevent dropdown from closing
        aiDifficulty = this.value;
        console.log('AI Difficulty changed to:', aiDifficulty); // Debug log
        if (gameMode === 'ai') {
            restartGame();
        }
    });
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            ...
                            if (aiDifficulty === 'easy') {
                                ...
                                bestCapture = additionalCaptures[0]; // Could enhance this
                            }
...
// AI Implementation - Fixed with proper difficulty levels
function makeAIMove() {
    if (gameEnded) return;
    ...
    console.log('AI making move with difficulty:', aiDifficulty); // Debug log
...
// Rest of the voice recognition functions remain the same...
