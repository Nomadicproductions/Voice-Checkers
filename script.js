...
function updateTurnDisplay() {
    const message = currentPlayer === 1 ?
        "Player 1's turn (Red L1–L12, skipping 2)" :
        gameMode === 'ai' ? "AI's turn (Black N1–N12, skipping 2)" : "Player 2's turn (Black N1–N12, skipping 2)";
...
function checkGameEnd() {
    ...
    if (player1Pieces === 0) {
        const winner = gameMode === 'ai' ? 'AI' : 'Player 2';
        statusElement.textContent = `${winner} (Black) Wins!`;
        speakMessage(`${winner} wins!`);
        gameEnded = true;
